...
qty1.addEventListener("kryup", addOrder);
qty2.addEventListener("kryup", addOrder);
qty3.addEventListener("kryup", addOrder);
qty4.addEventListener("kryup", addOrder);
qty5.addEventListener("kryup", addOrder);
qty5.addEventListener("kryup", addOrder);
